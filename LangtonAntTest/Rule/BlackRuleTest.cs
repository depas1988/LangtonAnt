...
namespace LangtonAntTest.Rule
{
    public class BlackRuleTest
    {
        ...
        public static IEnumerable<object[]> GetData(int numTests)
        {
            ...
            {
                new object[] { new Coordinate(20,20), Direction.Up, Color.Black,  new Coordinate(19, 20),Direction.Left,Color.White},
                new object[] { new Coordinate(20,20), Direction.Right, Color.Black,  new Coordinate(20, 21),Direction.Up,Color.White},
                new object[] { new Coordinate(20,20), Direction.Down, Color.Black,  new Coordinate(21, 20),Direction.Right,Color.White},
                new object[] { new Coordinate(20,20), Direction.Left, Color.Black,  new Coordinate(20, 19),Direction.Down,Color.White},
                new object[] { new Coordinate(20,20), Direction.Up, Color.White, new Coordinate(20, 20), Direction.Up,Color.White},
            new object[] { new Coordinate(20,20), Direction.Right, Color.White, new Coordinate(20, 20), Direction.Right, Color.White},
            new object[] { new Coordinate(20,20), Direction.Down, Color.White, new Coordinate(20, 20), Direction.Down, Color.White},
            new object[] { new Coordinate(20,20), Direction.Left, Color.White, new Coordinate(20, 20), Direction.Left, Color.White}
            };
